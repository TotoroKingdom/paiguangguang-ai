...
export function Homepage() {
  return (
    <div className="relative isolate overflow-hidden rounded-[32px] bg-[#050816] text-white">
      ...
      <div className="relative mx-auto flex w-full max-w-7xl flex-col gap-20 px-4 py-6 sm:px-6 lg:px-8 lg:py-10">
        <HomepageHero />
        <HomepageOverview />
        <HomepageTechStack />
        <HomepageProjects />
